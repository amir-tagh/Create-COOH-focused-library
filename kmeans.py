...
#first add an index for each smiles
#awk -F'\t' 'NR>0{$0=$0"\t"NR-1} 1'

#then remove the extra white space between first and second column
#sed -E 's/^(\S+)\s+/\1 /' inputfile

#convert the CVS to comma seperated
#sed 's/\,/\t/g'
